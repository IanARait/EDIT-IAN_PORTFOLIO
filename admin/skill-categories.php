...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (!isset($_POST[CSRF_TOKEN_NAME]) || !verifyCsrf($_POST[CSRF_TOKEN_NAME])) {
        ...
        redirect(ADMIN_URL . '/skill-categories.php');
    }
    ...
    if ($action === 'add_category') {
        ...
        setFlash('success', 'Skill category created successfully!');
        redirect(ADMIN_URL . '/skill-categories.php');
    }
    ...
    if ($action === 'edit_category') {
        ...
        setFlash('success', 'Skill category updated successfully!');
        redirect(ADMIN_URL . '/skill-categories.php');
    }
    ...
    if ($action === 'delete_category') {
        ...
        if ($result === -1) {
            setFlash('error', 'Cannot delete category — it still has skills assigned to it.');
        } else {
            setFlash('success', 'Skill category deleted successfully!');
        }
        redirect(ADMIN_URL . '/skill-categories.php');
    }
...
<div class="admin-content">
    <div class="admin-header">
        ...
        <div class="admin-header-actions">
            <a href="<?= ADMIN_URL ?>/skills.php" class="btn btn-secondary btn-sm" style="margin-right:8px;">
                ...
                <table class="data-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><span class="badge badge-primary"><?= (int)$cat['skill_count'] ?></span></td>
                            <td>
                                <div style="display:flex; gap:6px;">
                                    ...
                                    <button class="action-btn delete" onclick="confirmDeleteCategory(<?= $cat['id'] ?>, '<?= sanitize($cat['name']) ?>', <?= (int)$cat['skill_count'] ?>)" title="Delete"><i class="bi bi-trash"></i></button>
                                </div>
                            </td>
                        </tr>
                        <?php endforeach; ?>
                        ...
                        <tr>
                            <td colspan="4" style="text-align:center; padding:60px 20px; color:var(--text-secondary);">
                                ...
                                No skill categories yet. Click "Add Category" to create your first.
                            </td>
                        </tr>
                        <?php endif; ?>
                    </tbody>
                ...
                <form method="POST" id="categoryForm">
                    ...
                    <div class="modal-body" style="padding:24px;">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="name" id="cat_name" required placeholder="e.g., Software, Technique, Soft Skills">
                        </div>
                        <div class="form-group">
        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content" style="background:var(--bg-surface); border:1px solid var(--border-color); border-radius:20px;">
                ...
                <div class="modal-body" style="padding:24px; text-align:center;">
                    ...
                    <p id="deleteCategoryWarning" style="color:#ff4444; font-size:13px; margin-top:8px; display:none;">This category has skills — move them first!</p>
...
function confirmDeleteCategory(id, name, skillCount) {
